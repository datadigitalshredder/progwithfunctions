...
#     assert extract_given_name("Hove; Innocent") == "Hove"
#     assert extract_given_name("Costa; Higor") == "Costa"
#     assert extract_given_name("Garrett; Mitchelle") == "Garrett"
#     assert extract_given_name("Gueverra; Manuel") == "Gueverra"
#     assert extract_given_name("Tinoco; Jairo") == "Tinoco"
