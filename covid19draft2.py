...
def main():
    ...
    print()
    print('The file is a csv file and the dataFrame summury is as follows:')
    ...
    print(f'The positivity rate was \nIndex Positivity rate \n{positivity_rate}')
    print()
    ...
    visualization = input('Do you want to visualize the data (Y/N)?')
...
def positivity_rate_age():
    ...
    plt.plot(pos_rates_0_17_years, label='0-17 years rates')
    plt.plot(pos_rates_18_29_years, label='18-29 years rates')
    plt.plot(pos_rates_30_39_years, label='30-39 years rates')
    plt.plot(pos_rates_40_49_years, label='40-49 years rates')
    plt.plot(pos_rates_50_59_years, label='50-59 years rates')
    plt.plot(pos_rates_60_69_years, label='60-69 years rates')
    plt.plot(pos_rates_70_79_years, label='70-79 years rates')
    plt.plot(pos_rates_80_years, label='80+ years rates')
    plt.plot(pos_rates_unknown_years, label='Age Unknown rates')

    plt.title('Positivity rate by age in Chicago')
    plt.xlabel('Number of days')
...
def positivity_rate_gender():
    ...
    # plt.plot(pos_rates_values, label='overal positivity rates')
    plt.plot(pos_rates_female, label='positivity rates - female')
    plt.plot(pos_rates_male, label='positivity rates - male')
    plt.plot(pos_rates_gender_unknown, label='positivity rates - unknown gender')
    
    plt.title('Positivity rate by gender in Chicago')
    plt.xlabel('Number of days')
    plt.ylabel('Positivity rate')
    plt.legend()
    plt.show()  
...
def positivity_rate_race():
    ...
    plt.plot(pos_rates_latinx, label='Latinx rates')
    plt.plot(pos_rates_asian, label='Asian rates')
    plt.plot(pos_rates_black, label='Black rates')
    plt.plot(pos_rates_white, label='White years rates')
    plt.plot(pos_rates_other, label='Other Race rates')
    plt.plot(pos_rates_unknown_race, label='Unknown Race rates')
