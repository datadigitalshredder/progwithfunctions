...
def main():
    ...
    lb = float(input('Please enter your weight in US pounds: '))
    # stone = float(input('Please enter your weight in Stone: '))
    ...
    weight_in_kg = kg_from_lb(lb)
    # weight_in_stone = kg_from_stone(stone)
    ...
    print(f'Your weight is {weight_in_kg:.1f} kgs.')
...
def kg_from_lb(lb):
    ...
    """
    weight_in_kg = lb * 0.45359237
    return weight_in_kg

# def kg_from_stone(stone):
#     """Convert a mass in Stone to kilograms.
#     Parameter stone: a mass in British Stone.
#     Return: the mass in kilograms.
#     """
#     weight_in_kg = lb * 0.45359237
#     return weight_in_kg
