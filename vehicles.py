...
def main():
    ...
    if vin in vehicles:
        ...
        vehicle_manufacturer = value[MANUFACTURER_INDEX]
        vehicle_model = value[MODEL_INDEX]
        vehicle_color = value[COLOR_INDEX]
        print(f'The manufacturer is {vehicle_manufacturer}, the model is {vehicle_model}, and the color is {vehicle_color}.')
