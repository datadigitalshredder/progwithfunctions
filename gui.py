...
def main():
    ...
    frm_main.pack(padx=25, pady=3, fill=tk.BOTH, expand=1)
...
def populate_main_window(frm_main):
    ...
    ent_radius = numy.IntEntry(frm_main, 1, 1000, width=10)
    
    # if ent_radius.isdigit() == True:
        # label_error = tk.Label(frm_main, text="Your entry is valid:")
    # else:
        # label_error = tk.Label(frm_main, text="Your entry is not valid, please enter n integer between 0 and 1000")
    ...
    # label_error.grid( row=0, column=4, padx=3, pady=3)
    ...
    def calc(event):
        ...
        try:
            ...
            # Compute the user's the area of a circle.
